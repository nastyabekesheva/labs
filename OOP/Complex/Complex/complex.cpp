...
//  Complex
//
//  Created by Nastya Bekesheva on 26.06.2022.
//
...
complex<T, U>::complex() { }
    //  Parametr
template<typename T, typename U>
complex<T, U>::complex(T r, T i){
        _Re = r, _Im = i;
    }
    //  Copy || Convert
template<typename T, typename U>
complex<T, U>::complex(const T& complex){
...
T&complex<T, U>:: real() {
    ...
    //  Return real part of complex number
template<typename T, typename U>
const T&complex<T, U>:: real() const {
        return _Re;
    }
...
T&complex<T, U>:: imag() {
    ...
    //  Return imaginary part of complex number
template<typename T, typename U>
const T&complex<T, U>:: imag() const {
        return _Im;
    }
...
/*        Setters         */
    ...
    //  Set real part
template<typename T, typename U>
void complex<T, U>::real(T r) {
        _Re = r;
    }
    //  Set imaginary part
template<typename T, typename U>
void complex<T, U>::imag(T i) {
        _Im = i;
    }
...
template<typename T, typename U>
const complex<T, U>& complex<T, U>::operator=(const complex<T, U> other) {
...
complex<T, U> operator+(const complex<T, U>& other) {
        return complex<T, U>(_Re + other.real(), _Im + other.imag());
    }
